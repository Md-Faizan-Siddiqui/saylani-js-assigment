...
// document.write("You will have "+Math.floor((userCash/100))+" notes of hundred and "+Math.floor((userCash%100)/50)+" notes of 50 and "+Math.floor(((userCash%100)%50)/10)+" notes of 10");
